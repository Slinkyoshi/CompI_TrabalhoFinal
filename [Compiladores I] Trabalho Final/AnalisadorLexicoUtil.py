...
def tokenizar(lista):
    ...
    return verificaTokenizacao(l)



#FUNÇÃO AUXILIAR PARA VERIFICAR SE É UM NUMERO NA TOKENIZAÇÃO
...
#FUNÇÃO QUE VERIFICA SE A TOKENIZACAO FOI FEITA COM SUCESSO
def verificaTokenizacao(lista):
